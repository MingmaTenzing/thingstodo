    ...
    <div className="">
      ...
      <main className=" space-y-8 mt-10 p-4 py-3 mx-4   shadow-lg border md:m-auto rounded-3xl bg-slate-100 md:w-[900px] md:flex md:mt-20" >
        ...
        <div>
          ...
          <form id='form' onSubmit={addTask} className=" mt-10 p-5  space-y-5 flex flex-col items-center">
            <div>
              <h1 className="text-sm">Task Title</h1>
              <input
                type="text"
                value={tasktitle}
                className="border  outline-none w-[300px] p-2 h-10 rounded-lg" onChange={(e) => settasktitle(e.target.value)}
              ></input>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="border  outline-none p-2 w-[300px] h-[100px] rounded-lg" onChange={ (e) => setTaskDescription(e.target.value)}

              ></input>
            </div>
            <button onClick={addTask} className="p-3 bg-thingstodo rounded-lg text-white">
              {" "}
              Add Task{" "} 
            </button>
          </form>
